...
# Use a regex separator for whitespace to support environments where
# `delim_whitespace` isn't accepted by the installed pandas-like API.
data = pd.read_csv('housing.csv', header=None, sep='\s+', engine='python')
