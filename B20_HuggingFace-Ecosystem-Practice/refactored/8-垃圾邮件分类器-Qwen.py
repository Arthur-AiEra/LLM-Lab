...
modelscope_model_id = "Qwen/Qwen2.5-7B-Instruct"  # ModelScope 上的模型 ID, https://huggingface.co/Qwen/Qwen2.5-VL-7B-Instruct/tree/main, 16.6GB
cache_dir = "/private/var/ifc/app_data/autodl-tmp/models"  # 指定模型下载和缓存的文件夹
